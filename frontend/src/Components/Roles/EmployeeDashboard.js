...
const EmployeeDashboard = () => {
  ...
  return (
    <div>
      {error && <p>{error}</p>}
      <div className= "employee-dash" style={{ overflowY: 'auto', maxHeight: '250px', marginBottom: '20px' }}>
          <h3>Meine Anträge</h3>
      ...
      <button className="meine-antrage" onClick={handleMeine}>Antrag erstellen</button>
    </div>
  );
};
